...
namespace CAPA_PRESENTACION
{
    class Datetimepicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Properties.Resources.Calendario_white;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Properties.Resources.Calendario_black;
                else calendarIcon = Properties.Resources.Calendario_white;
                this.Invalidate();
            }
        }
